...
Event.create(name: 'One if by Land Two if by Sea', 
             ...
             image: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80",
             intro: 'You should go to One if by Land Two if by Sea!'
            )
...
Event.create(name: 'Casa Mono', 
             ...
             image: "https://images.unsplash.com/photo-1471253794676-0f039a6aae9d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1740&q=80",
             intro: 'You should go to Casa Mono!'
            )
...
Event.create(name: 'Fradei', 
             ...
             image: "https://images.unsplash.com/photo-1533777857889-4be7c70b33f7?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80",       
             intro: 'You should go to Fradei!'
            )
...
Event.create(name: 'BrickHouse Ceramic Art Center', 
             ...
             intro: 'You should take a Ceramic class!'
            )
...
Event.create(name: 'Cooking Class with Cozymeal', 
             ...
             image: "https://images.unsplash.com/photo-1556910103-1c02745aae4d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=3270&q=80",
             intro: 'You should take a Cooking Class!'
            )
...
With best-in-class amenities such as plush, power recliners, MacGuffins full bars, AMC Dine-In Theatres, premium presentation formats including Dolby Cinema at AMC and IMAX, AMC is recognized as the industry leader and an iconic destination for movie-goers.', 
             ...
             image: "https://images.unsplash.com/photo-1605034949929-6af5f19593b3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8bW92ZSUyMHRoZWF0ZXJ8ZW58MHwwfDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60",
             intro: 'You should go see a Movie!'
            )
...
Event.create(name: 'Concert', 
             ...
             intro: 'You should go see a concert'
            )
...
Event.create(name: 'Play', 
             ...
             intro: 'You should go see a Play!'
            )
...
Event.create(name: 'Beach day', 
             ...
             intro: 'You should go to the Beach!'
            )
...
Event.create(name: 'Park day',
             ...
             image: "https://images.unsplash.com/photo-1585938389612-a552a28d6914?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2060&q=80", 
             intro: 'You should go to the Park!'
            )
...
Event.create(name: 'Sight seeing', 
             ...
             intro: 'You should go Sight Seeing.'
            )
...
Event.create(name: 'Rock Climbing at The Cliffs', 
             ...
             intro: 'You should go Rock Climbing!'
            )
